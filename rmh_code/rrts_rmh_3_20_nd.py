...
class RRT():
    ...
    def DrawGraph(self, rnd=None):
        ...
        # plt.plot(self.start.jr0, 0, "go")
        # plt.plot(self.start.jr1,  0.5, "go")
        # plt.plot(self.start.jr2,  1.0, "go")
        # plt.plot(self.start.jr3,  1.50, "og")
        # plt.plot(self.start.jr4,  2.0, "og")
        # plt.plot(self.start.jr5,  2.50, "og")
        # plt.plot(self.start.jr6, 3.0, "og")
        # plt.plot(self.start.jl0, 3.50, "og")
        # plt.plot(self.start.jl1, 4.0, "og")
        # plt.plot(self.start.jl2,  4.50, "og")
        # plt.plot(self.start.jl3, 5.0, "og")
        # plt.plot(self.start.jl4,  5.50, "og")
        # plt.plot(self.start.jl5,  6.0, "og")
        # plt.plot(self.start.jl6,  6.50, "og")
        # plt.plot(self.end.jr0, 0, "rx")
        # plt.plot(self.end.jr1,  0.5, "rx")
        # plt.plot(self.end.jr2,  1.0, "rx")
        # plt.plot(self.end.jr3,  1.50, "rx")
        # plt.plot(self.end.jr4,  2.0, "rx")
        # plt.plot(self.end.jr5,  2.50, "rx")
        # plt.plot(self.end.jr6, 3.0, "rx")
        # plt.plot(self.end.jl0, 3.50, "rx")
        # plt.plot(self.end.jl1, 4.0, "rx")
        # plt.plot(self.end.jl2,  4.50, "rx")
        # plt.plot(self.end.jl3, 5.0, "rx")
        # plt.plot(self.end.jl4,  5.50, "rx")
        # plt.plot(self.end.jl5,  6.0, "rx")
        # plt.plot(self.end.jl6,  6.50, "rx")
